...
describe('Test Data Builder', () => {
  ...
  describe('Product Validation Rules', () => {
    it('should return an onject error when creating a Product with invalid id', () => {
    ...
    it('should return an onject error when creating a Product with invalid name', () => {
    ...
    it('should return an onject error when creating a Product with invalid price', () => {
    ...
    it('should return an onject error when creating a Product with invalid category', () => {
      const product = ProductDataBuilder.aProduct().withInvalidCategory().build()
      const result = productValidator(product)
      const expected = {
        errors: ['category: invalid value, current [mecanic] expected to be electronic ir organic'],
        result: false
      }
      expect(result).to.be.deep.equal(expected)
    })
